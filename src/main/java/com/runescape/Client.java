package com.runescape;// Decompiled by Jad v1.5.8f. Copyright 2001 Pavel Kouznetsov.
// Jad home page: http://www.kpdus.com/jad.html
// Decompiler options: packimports(3) 

import com.runescape.cache.Decompressor;
import com.runescape.cache.StreamLoader;
import com.runescape.cache.config.Censor;
import com.runescape.cache.config.VarBit;
import com.runescape.cache.config.Varp;
import com.runescape.cache.def.EntityDef;
import com.runescape.cache.def.Flo;
import com.runescape.cache.def.ItemDef;
import com.runescape.cache.def.ObjectDef;
...
import com.runescape.gpu.SkyboxPlugin;
import com.runescape.gpu.config.AntiAliasingMode;
import com.runescape.media.*;
import com.runescape.media.renderable.*;
...
import com.runescape.net.ISAACRandomGen;
import com.runescape.net.RSSocket;
import com.runescape.net.Stream;
import com.runescape.net.requester.OnDemandData;
import com.runescape.net.requester.OnDemandFetcher;
import com.runescape.scene.Region;
import com.runescape.scene.Scene;
import com.runescape.scene.tile.GroundObject;
import com.runescape.scene.tile.WallObject;
import com.runescape.scene.tile.DecorativeObject;
import com.runescape.scene.util.CollisionMap;
import com.runescape.scene.SceneSpawnNode;
import com.runescape.scene.tile.GameObject;
...
public class Client extends RSApplet {
    ...
    public GpuPlugin gpu;
    public SkyboxPlugin skybox;
    ...
    public void setSkyboxColor(final int newSkyboxColor) {
    ...
    public int get3dZoom() {
        return 512; //whatever your fov is
    }
    ...
    public int getViewportHeight() {
        return gameBuffer.getHeight();
    }

    public int getViewportWidth() {
        return gameBuffer.getWidth();
    }

    public int getCanvasWidth() {
        return mainBuffer.getWidth();
    }

    public int getCanvasHeight() {
        return mainBuffer.getHeight();
    }
    ...
    public int getCameraX2() {
        return scene.cameraX2;
    }

    public int getCameraY2() {
        return scene.cameraY2;
    }

    public int getCameraZ2() {
        return scene.cameraZ2;
    }
    ...
    public ProducingGraphicsBuffer backLeft1Graphics;
    public ProducingGraphicsBuffer backLeft2Graphics;
    public ProducingGraphicsBuffer backRight1Graphics;
    public ProducingGraphicsBuffer backRight2Graphics;
    public ProducingGraphicsBuffer backTop1Graphics;
    public ProducingGraphicsBuffer backMid1Graphics;
    public ProducingGraphicsBuffer backMid2Graphics;
    public ProducingGraphicsBuffer backMid3Graphics;
    public ProducingGraphicsBuffer backMid4Graphics;
    ...
    private ProducingGraphicsBuffer aRSImageProducer_1107;
    private ProducingGraphicsBuffer aRSImageProducer_1108;
    private ProducingGraphicsBuffer aRSImageProducer_1109;
    private ProducingGraphicsBuffer aRSImageProducer_1110;
    private ProducingGraphicsBuffer aRSImageProducer_1111;
    private ProducingGraphicsBuffer aRSImageProducer_1112;
    private ProducingGraphicsBuffer aRSImageProducer_1113;
    private ProducingGraphicsBuffer aRSImageProducer_1114;
    private ProducingGraphicsBuffer aRSImageProducer_1115;
    private int membersInt;
    private String aString1121;
    private Sprite compass;
    public ProducingGraphicsBuffer chatOptionsBuffer;
    public ProducingGraphicsBuffer topTabBuffer;
    public ProducingGraphicsBuffer bottomTabBuffer;
    ...
    public boolean dynamicRegion;
    private boolean aBoolean1160;
    public ProducingGraphicsBuffer tabBuffer;
    public ProducingGraphicsBuffer mapBuffer;
    public ProducingGraphicsBuffer gameBuffer;
    public ProducingGraphicsBuffer chatBuffer;
 ...
 */
    ...
    private void drawChatArea() {
        ...
        if (messagePromptRaised) {
            ...
            int j = 0;
            Raster.setDrawingArea(77, 0, 463, 0);
            for (int k = 0; k < 100; k++)
    ...
    private void method22() {
        try {
            ...
            for (int l = 0; l < 4; l++) {
                for (int k1 = 0; k1 < 104; k1++) {
                    for (int j2 = 0; j2 < 104; j2++)
                        tileSettings[l][k1][j2] = 0;

                }

            }

            Region objectManager = new Region(tileSettings, tileHeights);
            ...
            if (k3 > currentPlane)
                k3 = currentPlane;
            if (k3 < currentPlane - 1)
                k3 = currentPlane - 1;
            if (lowMem)
                scene.method275(Region.anInt145);
            else
                scene.method275(0);
    ...
    private void method24(int i) {
        ...
        for (int l = 1; l < 103; l++) {
            ...
            for (int k1 = 1; k1 < 103; k1++) {
                if ((tileSettings[i][k1][l] & 0x18) == 0)
                    scene.method309(ai, i1, i, k1, l);
                if (i < 3 && (tileSettings[i + 1][k1][l] & 8) != 0)
        ...
        for (int i2 = 1; i2 < 103; i2++) {
            for (int j2 = 1; j2 < 103; j2++) {
                if ((tileSettings[i][j2][i2] & 0x18) == 0)
                    method50(i2, j1, j2, l1, i);
                if (i < 3 && (tileSettings[i + 1][j2][i2] & 8) != 0)
        ...
        for (int k2 = 0; k2 < 104; k2++) {
            for (int l2 = 0; l2 < 104; l2++) {
                int i3 = scene.method303(currentPlane, k2, l2);
                if (i3 != 0) {
                    i3 = i3 >> 14 & 0x7fff;
                    ...
                    if (j3 >= 0) {
                        ...
                        if (j3 != 22 && j3 != 29 && j3 != 34 && j3 != 36 && j3 != 46 && j3 != 47 && j3 != 48) {
                            byte byte0 = 104;
                            byte byte1 = 104;
                            int ai1[][] = aClass11Array1230[currentPlane].anIntArrayArray294;
    ...
    private void spawnGroundItem(int i, int j) {
        NodeList class19 = groundArray[currentPlane][i][j];
        if (class19 == null) {
            scene.method295(currentPlane, i, j);
            return;
        }
        int k = 0xfa0a1f01;
        Object obj = null;
...
//	notifyItemSpawn(item, i + baseX, j + baseY);
        ...
        scene.method281(i, i1, ((Renderable) (obj1)), method42(currentPlane, j * 128 + 64, i * 128 + 64), ((Renderable) (obj2)), ((Renderable) (obj)), currentPlane, j);
    }
    ...
    private void method26(boolean flag) {
        for (int j = 0; j < npcCount; j++) {
            ...
            if (!npc.desc.aBoolean84)
                k += 0x80000000;
            scene.method285(currentPlane, npc.anInt1552, method42(currentPlane, npc.y, npc.x), k, npc.y, (npc.anInt1540 - 1) * 64 + 60, npc.x, npc, npc.aBoolean1541);
        }
    }
    ...
    private void method30(int j, int k, int l, int i1, int j1) {
        ...
        Raster.method336(j - 32, l + 16, i1, anInt1002, 16, false);
        int k1 = ((j - 32) * j) / j1;
        if (k1 < 8)
            k1 = 8;
        int l1 = ((j - 32 - k1) * k) / (j1 - j);
        Raster.method336(k1, l + 16 + l1, i1, anInt1063, 16, false);
        Raster.method341(l + 16 + l1, anInt902, k1, i1);
        Raster.method341(l + 16 + l1, anInt902, k1, i1 + 1);
        Raster.method339(l + 16 + l1, anInt902, 16, i1);
        Raster.method339(l + 17 + l1, anInt902, 16, i1);
        Raster.method341(l + 16 + l1, anInt927, k1, i1 + 15);
        Raster.method341(l + 17 + l1, anInt927, k1 - 1, i1 + 14);
        Raster.method339(l + 15 + l1 + k1, anInt927, 16, i1);
        Raster.method339(l + 14 + l1 + k1, anInt927, 15, i1 + 1);
    }
            ...
            for (int j = -1; j < playerCount + npcCount; j++) {
                ...
                if (((Actor) (obj)).textSpoken != null && (j >= playerCount || publicChatMode == 0 || publicChatMode == 3 || publicChatMode == 1 && isFriendOrSelf(((Player) obj).name))) {
                    ...
                    if (spriteDrawX > -1 && anInt974 < anInt975) {
                        anIntArray979[anInt974] = chatTextDrawingArea.method384(((Actor) (obj)).textSpoken) / 2;
                ...
                if (((Actor) (obj)).loopCycleStatus > loopCycle) {
                    try {
                        ...
                        if (spriteDrawX > -1) {
                            ...
                            if (i1 > 30)
                                i1 = 30;
                            Raster.method336(5, spriteDrawY - 3, spriteDrawX - 15, 65280, i1, false);
                            Raster.method336(5, spriteDrawY - 3, (spriteDrawX - 15) + i1, 0xff0000, 30 - i1, false);
                        }
                    } catch (Exception e) {
                    }
                }
                for (int j1 = 0; j1 < 4; j1++)
                    if (((Actor) (obj)).hitsLoopCycle[j1] > loopCycle) {
                        npcScreenPos(((Actor) (obj)), ((Actor) (obj)).height / 2);
                        if (spriteDrawX > -1) {
                            if (j1 == 1)
                                spriteDrawY -= 20;
                            if (j1 == 2) {
                            ...
                            hitMarks[((Actor) (obj)).hitMarkTypes[j1]].drawSprite(spriteDrawX - 12, spriteDrawY - 12);
                            aTextDrawingArea_1270.drawText(0, String.valueOf(((Actor) (obj)).hitArray[j1]), spriteDrawY + 4, spriteDrawX);
                            aTextDrawingArea_1270.drawText(0xffffff, String.valueOf(((Actor) (obj)).hitArray[j1]), spriteDrawY + 3, spriteDrawX - 1);
                        }
                    }
                ...
                if (anInt1249 == 0) {
                    ...
                    if (anIntArray981[k] == 5) {
                        ...
                        if (j4 < 25)
                            ...
                            l4 = j4 - 125;
                        Raster.setDrawingArea(spriteDrawY + 5, 0, 512, spriteDrawY - chatTextDrawingArea.anInt1497 - 1);
    ...
    private void drawTabArea() {
        ...
        if (menuOpen && menuScreenArea == 1)
            drawMenu();
        tabBuffer.draw(super.graphics, 553, 205);
        gameBuffer.init();
        Rasterizer3D.anIntArray1472 = anIntArray1182;
    }
    ...
    public void method37(int j) {
        if (!lowMem) {
            if (Rasterizer3D.anIntArray1480[17] >= j) {
                Background background = Rasterizer3D.textures[17];
                ...
                if (GpuPlugin.process()) {
                    gpu.animate(Rasterizer3D.textures[17], anInt945);
                }
                anInt854++;
                if (anInt854 > 1235) {
                    anInt854 = 0;
            ...
            if (Rasterizer3D.anIntArray1480[24] >= j) {
                Background background_1 = Rasterizer3D.textures[24];
                ...
                if (GpuPlugin.process()) {
                    gpu.animate(Rasterizer3D.textures[24], anInt945);
                }
            }
            if (Rasterizer3D.anIntArray1480[34] >= j) {
                Background background_2 = Rasterizer3D.textures[34];
                ...
                if (GpuPlugin.process()) {
                    gpu.animate(Rasterizer3D.textures[34], anInt945);
                }
            }
            if (Rasterizer3D.anIntArray1480[40] >= j) {
                Background background_2 = Rasterizer3D.textures[40];
                int i1 = background_2.anInt1452 * background_2.anInt1453 - 1;
                int l1 = background_2.anInt1452 * anInt945 * 2;
                byte abyte2[] = background_2.aByteArray1450;
                byte abyte5[] = aByteArray912;
                ...
                if (GpuPlugin.process()) {
                    gpu.animate(Rasterizer3D.textures[40], anInt945);
                }
            }
        }
    }
    ...
    private void calcCameraPos() {
        ...
        int k = method42(currentPlane, j, i) - anInt1100;
        if (cameraX < i) {
            cameraX += anInt1101 + ((i - cameraX) * anInt1102) / 1000;
            if (cameraX > i)
                cameraX = i;
        }
        if (cameraX > i) {
            cameraX -= anInt1101 + ((cameraX - i) * anInt1102) / 1000;
            if (cameraX < i)
                cameraX = i;
        }
        if (cameraZ < k) {
            cameraZ += anInt1101 + ((k - cameraZ) * anInt1102) / 1000;
            if (cameraZ > k)
                cameraZ = k;
        }
        if (cameraZ > k) {
            cameraZ -= anInt1101 + ((cameraZ - k) * anInt1102) / 1000;
            if (cameraZ < k)
                cameraZ = k;
        }
        if (cameraY < j) {
            cameraY += anInt1101 + ((j - cameraY) * anInt1102) / 1000;
            if (cameraY > j)
                cameraY = j;
        }
        if (cameraY > j) {
            cameraY -= anInt1101 + ((cameraY - j) * anInt1102) / 1000;
            if (cameraY < j)
                cameraY = j;
        }
        i = anInt995 * 128 + 64;
        j = anInt996 * 128 + 64;
        k = method42(currentPlane, j, i) - anInt997;
        int l = i - cameraX;
        int i1 = k - cameraZ;
        int j1 = j - cameraY;
    ...
    private void drawMenu() {
        ...
        int l = anInt952;
        int i1 = 0x5d5447;
        Raster.method336(l, j, i, i1, k, false);
        Raster.method336(16, j + 1, i + 1, 0, k - 2, false);
        Raster.fillPixels(i + 1, k - 2, l - 19, 0, j + 18);
    ...
    private void addFriend(long l) {
        try {
            ...
            String s = TextUtilities.fixName(TextUtilities.nameForLong(l));
            for (int i = 0; i < friendsCount; i++)
                if (friendsListAsLongs[i] == l) {
    ...
    private void method47(boolean flag) {
        ...
        for (int l = 0; l < j; l++) {
            ...
            if (player.aModel_1714 != null && loopCycle >= player.anInt1707 && loopCycle < player.anInt1708) {
                ...
                player.anInt1709 = method42(currentPlane, player.y, player.x);
                scene.method286(currentPlane, player.y, player, player.anInt1552, player.anInt1722, player.x, player.anInt1709, player.anInt1719, player.anInt1721, i1, player.anInt1720);
                continue;
            }
            ...
            player.anInt1709 = method42(currentPlane, player.y, player.x);
            scene.method285(currentPlane, player.anInt1552, player.anInt1709, i1, player.y, 60, player.x, player, player.aBoolean1541);
        }
    ...
    private boolean promptUserForInput(RSInterface class9) {
        ...
        if (j >= 601 && j <= 612) {
            ...
            if (reportAbuseInput.length() > 0) {
                ...
                stream.writeQWord(TextUtilities.longForName(reportAbuseInput));
    ...
    private void loadTitleScreen() {
        ...
        System.arraycopy(aRSImageProducer_1110.pixels, 0, aClass30_Sub2_Sub1_Sub1_1201.myPixels, 0, 33920);

        System.arraycopy(aRSImageProducer_1111.pixels, 0, aClass30_Sub2_Sub1_Sub1_1202.myPixels, 0, 33920);
    ...
    private void loadingStages() {
        if (lowMem && loadingStage == 2 && Region.anInt131 != currentPlane) {
            gameBuffer.init();
            ...
            gameBuffer.draw(super.graphics, 4, 4);
            loadingStage = 1;
        ...
        if (loadingStage == 1) {
            ...
            if (j != 0 && System.currentTimeMillis() - aLong824 > 0x57e40L) {
                Signlink.reporterror(myUsername + " glcfb " + aLong1215 + "," + j + "," + lowMem + "," + decompressors[0] + "," + onDemandFetcher.getNodeCount() + "," + currentPlane + "," + anInt1069 + "," + anInt1070);
                aLong824 = System.currentTimeMillis();
            }
        }
        if (loadingStage == 2 && currentPlane != anInt985) {
            anInt985 = currentPlane;
            method24(currentPlane);
        }
    }
    ...
    private void method55() {
        for (Projectile class30_sub2_sub4_sub4 = (Projectile) aClass19_1013.reverseGetFirst(); class30_sub2_sub4_sub4 != null; class30_sub2_sub4_sub4 = (Projectile) aClass19_1013.reverseGetNext())
            if (class30_sub2_sub4_sub4.anInt1597 != currentPlane || loopCycle > class30_sub2_sub4_sub4.anInt1572)
                ...
                scene.method285(currentPlane, class30_sub2_sub4_sub4.anInt1595, (int) class30_sub2_sub4_sub4.aDouble1587, -1, (int) class30_sub2_sub4_sub4.aDouble1586, 60, (int) class30_sub2_sub4_sub4.aDouble1585, class30_sub2_sub4_sub4, false);
            }
    ...
    private void drawLogo() {
        ...
        aRSImageProducer_1110.init();
        sprite.method346(0, 0);
        aRSImageProducer_1111.init();
        sprite.method346(-637, 0);
        aRSImageProducer_1107.init();
        sprite.method346(-128, 0);
        aRSImageProducer_1108.init();
        sprite.method346(-202, -371);
        aRSImageProducer_1109.init();
        sprite.method346(-202, -171);
        aRSImageProducer_1112.init();
        sprite.method346(0, -265);
        aRSImageProducer_1113.init();
        sprite.method346(-562, -265);
        aRSImageProducer_1114.init();
    ...
    private void processOnDemandQueue() {
        do {
            ...
            Region.method173(new Stream(onDemandData.buffer), onDemandFetcher);
        } while (true);
    }
    ...
    private void mainGameProcessor() {
        ...
        if (!loggedIn)
            return;
        synchronized (mouseCapturer.syncObject) {
            if (flagged) {
                if (super.clickMode3 != 0 || mouseCapturer.coordsIndex >= 40) {
                    stream.createFrame(45);
                    stream.writeWordBigEndian(0);
                    int j2 = stream.currentOffset;
                    int j3 = 0;
                    for (int j4 = 0; j4 < mouseCapturer.coordsIndex; j4++) {
                        if (j2 - stream.currentOffset >= 240)
                            break;
                        j3++;
                        int l4 = mouseCapturer.coordsY[j4];
                        if (l4 < 0)
                            l4 = 0;
                        else if (l4 > 502)
                            l4 = 502;
                        int k5 = mouseCapturer.coordsX[j4];
                        if (k5 < 0)
                            k5 = 0;
                        else if (k5 > 764)
                            k5 = 764;
                        int i6 = l4 * 765 + k5;
                        if (mouseCapturer.coordsY[j4] == -1 && mouseCapturer.coordsX[j4] == -1) {
                            k5 = -1;
                            l4 = -1;
                            i6 = 0x7ffff;
                        }
                    ...
                    if (j3 >= mouseCapturer.coordsIndex) {
                        mouseCapturer.coordsIndex = 0;
                    } else {
                        mouseCapturer.coordsIndex -= j3;
                        for (int i5 = 0; i5 < mouseCapturer.coordsIndex; i5++) {
                            mouseCapturer.coordsX[i5] = mouseCapturer.coordsX[i5 + j3];
                            mouseCapturer.coordsY[i5] = mouseCapturer.coordsY[i5 + j3];
                        }
    ...
    private void method63() {
        SceneSpawnNode class30_sub1 = (SceneSpawnNode) aClass19_1179.reverseGetFirst();
        for (; class30_sub1 != null; class30_sub1 = (SceneSpawnNode) aClass19_1179.reverseGetNext())
    ...
    private void resetImageProducers() {
        if (aRSImageProducer_1107 != null)
            return;
        super.mainBuffer = null;
        chatBuffer = null;
        mapBuffer = null;
        tabBuffer = null;
        gameBuffer = null;
        chatOptionsBuffer = null;
        topTabBuffer = null;
        bottomTabBuffer = null;
        aRSImageProducer_1110 = new ProducingGraphicsBuffer(128, 265, getGameComponent());
        Raster.setAllPixelsToZero();
        aRSImageProducer_1111 = new ProducingGraphicsBuffer(128, 265, getGameComponent());
        Raster.setAllPixelsToZero();
        aRSImageProducer_1107 = new ProducingGraphicsBuffer(509, 171, getGameComponent());
        Raster.setAllPixelsToZero();
        aRSImageProducer_1108 = new ProducingGraphicsBuffer(360, 132, getGameComponent());
        Raster.setAllPixelsToZero();
        aRSImageProducer_1109 = new ProducingGraphicsBuffer(360, 200, getGameComponent());
        Raster.setAllPixelsToZero();
        aRSImageProducer_1112 = new ProducingGraphicsBuffer(202, 238, getGameComponent());
        Raster.setAllPixelsToZero();
        aRSImageProducer_1113 = new ProducingGraphicsBuffer(203, 238, getGameComponent());
        Raster.setAllPixelsToZero();
        aRSImageProducer_1114 = new ProducingGraphicsBuffer(74, 94, getGameComponent());
        Raster.setAllPixelsToZero();
        aRSImageProducer_1115 = new ProducingGraphicsBuffer(75, 94, getGameComponent());
        Raster.setAllPixelsToZero();
    ...
    void drawLoadingText(int i, String s) {
        ...
        Raster.method336(30, j + 2, c / 2 - 150, 0x8c1111, i * 3, false);
        Raster.method336(30, j + 2, (c / 2 - 150) + i * 3, 0, 300 - i * 3, false);
        chatTextDrawingArea.drawText(0xffffff, s, (c1 / 2 + 5) - byte1, c / 2);
        aRSImageProducer_1109.draw(super.graphics, 202, 171);
        if (welcomeScreenRaised) {
            welcomeScreenRaised = false;
            if (!aBoolean831) {
                aRSImageProducer_1110.draw(super.graphics, 0, 0);
                aRSImageProducer_1111.draw(super.graphics, 637, 0);
            }
            aRSImageProducer_1107.draw(super.graphics, 128, 0);
            aRSImageProducer_1108.draw(super.graphics, 202, 371);
            aRSImageProducer_1112.draw(super.graphics, 0, 265);
            aRSImageProducer_1113.draw(super.graphics, 562, 265);
            aRSImageProducer_1114.draw(super.graphics, 128, 171);
            aRSImageProducer_1115.draw(super.graphics, 562, 171);
        }
    }
    ...
    private boolean method66(int i, int j, int k) {
        int i1 = i >> 14 & 0x7fff;
        int j1 = scene.method304(currentPlane, k, j, i);
        if (j1 == -1)
            return false;
        int k1 = j1 & 0x1f;
        int l1 = j1 >> 6 & 3;
  ...
  */
    ...
    private void doAction(int i) {
        ...
        if (l == 337 || l == 42 || l == 792 || l == 322) {
            ...
            if (k1 != -1) {
                long l3 = TextUtilities.longForName(s.substring(k1 + 5).trim());
                if (l == 337)
                    addFriend(l3);
                if (l == 42)
                    addIgnore(l3);
    ...
    private void build3dScreenMenu() {
        ...
        for (int k = 0; k < Model.anInt1687; k++) {
            ...
            if (l == j)
                continue;
            j = l;
            if (k1 == 2 && scene.method304(currentPlane, i1, j1, l) >= 0) {
            ...
            if (k1 == 3) {
                NodeList class19 = groundArray[currentPlane][i1][j1];
                if (class19 != null) {
    ...
    public void cleanUpForQuit() {
        ...
        topTabBuffer = null;
        bottomTabBuffer = null;
        backLeft1Graphics = null;
        backLeft2Graphics = null;
        backRight1Graphics = null;
        backRight2Graphics = null;
        backTop1Graphics = null;
        backMid1Graphics = null;
        backMid2Graphics = null;
        backMid3Graphics = null;
        backMid4Graphics = null;
        invBack = null;
        mapBack = null;
        chatBack = null;
        backBase1 = null;
            ...
            if (openInterfaceID != -1 && openInterfaceID == reportAbuseInterfaceID) {
                ...
                if (j == 13 || j == 10) {
                    ...
                    if (friendsListAction == 3 && promptInput.length() > 0) {
                        ...
                        ChatEncoder.method526(promptInput, stream);
                ...
                if (j == 13 || j == 10) {
                    if (amountOrNameInput.length() > 0) {
                        ...
                        stream.writeQWord(TextUtilities.longForName(amountOrNameInput));
                    }
                    inputDialogState = 0;
                    inputTaken = true;
                }
                ...
                if ((j == 13 || j == 10) && inputString.length() > 0) {
                    if (inputString.equalsIgnoreCase("::gpu")) {
                       if (GpuPlugin.process()) {
                           gpu.shutDown();
                       } else {
                           gpu.startUp();
                        ...
                        backLeft1Graphics = new ProducingGraphicsBuffer(sprite.myWidth, sprite.myHeight, getGameComponent());
                        sprite.method346(0, 0);
                        sprite = new Sprite(streamLoader_2, "backleft2", 0);
                        backLeft2Graphics = new ProducingGraphicsBuffer(sprite.myWidth, sprite.myHeight, getGameComponent());
                        sprite.method346(0, 0);
                        sprite = new Sprite(streamLoader_2, "backright1", 0);
                        backRight1Graphics = new ProducingGraphicsBuffer(sprite.myWidth, sprite.myHeight, getGameComponent());
                        sprite.method346(0, 0);
                        sprite = new Sprite(streamLoader_2, "backright2", 0);
                        backRight2Graphics = new ProducingGraphicsBuffer(sprite.myWidth, sprite.myHeight, getGameComponent());
                        sprite.method346(0, 0);
                        sprite = new Sprite(streamLoader_2, "backtop1", 0);
                        backTop1Graphics = new ProducingGraphicsBuffer(sprite.myWidth, sprite.myHeight, getGameComponent());
                        sprite.method346(0, 0);
                        sprite = new Sprite(streamLoader_2, "backvmid1", 0);
                        backMid1Graphics = new ProducingGraphicsBuffer(sprite.myWidth, sprite.myHeight, getGameComponent());
                        sprite.method346(0, 0);
                        sprite = new Sprite(streamLoader_2, "backvmid2", 0);
                        backMid2Graphics = new ProducingGraphicsBuffer(sprite.myWidth, sprite.myHeight, getGameComponent());
                        sprite.method346(0, 0);
                        sprite = new Sprite(streamLoader_2, "backvmid3", 0);
                        backMid3Graphics = new ProducingGraphicsBuffer(sprite.myWidth, sprite.myHeight, getGameComponent());
                        sprite.method346(0, 0);
                        sprite = new Sprite(streamLoader_2, "backhmid2", 0);
                        backMid4Graphics = new ProducingGraphicsBuffer(sprite.myWidth, sprite.myHeight, getGameComponent());
                        sprite.method346(0, 0);
                    ...
                    if (inputString.equalsIgnoreCase("::aa")) {
                        if (GpuPlugin.process()) {
                            final AntiAliasingMode[] modes = AntiAliasingMode.values();
                            int old = gpu.currentAntiAliasingMode.ordinal();
                            old += 1;
                            if (old >= modes.length) {
                                old = 0;
                            }
                            gpu.currentAntiAliasingMode = modes[old];
                            pushMessage("Current Anti Aliasing mode: " + gpu.currentAntiAliasingMode.name(), 0, "");
                            return;
                        }
                    }
                    ...
                    if (inputString.startsWith("::")) {
                        ...
                        ChatEncoder.method526(inputString, aStream_834);
    ...
    private void drawFriendsListOrWelcomeScreen(RSInterface class9) {
        ...
        if (j >= 401 && j <= 500) {
            ...
            if (j >= j1) {
                ...
                class9.message = TextUtilities.fixName(TextUtilities.nameForLong(ignoreListAsLongs[j]));
                class9.atActionType = 1;
                return;
            }
        }
    ...
    private void resetImageProducers2() {
        if (chatBuffer != null)
            return;
        nullLoader();
        super.mainBuffer = new ProducingGraphicsBuffer(765, 503, getGameComponent());
        aRSImageProducer_1107 = null;
        aRSImageProducer_1108 = null;
        aRSImageProducer_1109 = null;
        aRSImageProducer_1110 = null;
        ...
        aRSImageProducer_1114 = null;
        aRSImageProducer_1115 = null;
        chatBuffer = new ProducingGraphicsBuffer(479, 96, getGameComponent());
        mapBuffer = new ProducingGraphicsBuffer(172, 156, getGameComponent());
        Raster.setAllPixelsToZero();
        mapBack.method361(0, 0);
        tabBuffer = new ProducingGraphicsBuffer(190, 261, getGameComponent());
        gameBuffer = new ProducingGraphicsBuffer(512, 334, getGameComponent());
        Raster.setAllPixelsToZero();
        chatOptionsBuffer = new ProducingGraphicsBuffer(496, 50, getGameComponent());
        topTabBuffer = new ProducingGraphicsBuffer(269, 37, getGameComponent());
        bottomTabBuffer = new ProducingGraphicsBuffer(249, 45, getGameComponent());
        welcomeScreenRaised = true;
    }
    ...
    private void login(String s, String s1, boolean flag) {
        ...
        try {
            ...
            long l = TextUtilities.longForName(s);
            int i = (int) (l >> 16 & 31L);
            stream.currentOffset = 0;
    ...
    private boolean doWalkTo(int i, int j, int k, int i1, int j1, int k1,
        ...
        boolean flag1 = false;
        int j4 = bigX.length;
        int ai[][] = aClass11Array1230[currentPlane].anIntArrayArray294;
        while (i4 != l3) {
            j3 = bigX[i4];
            k3 = bigY[i4];
            i4 = (i4 + 1) % j4;
            ...
            if (i1 != 0) {
                if ((i1 < 5 || i1 == 10) && aClass11Array1230[currentPlane].method219(k2, j3, k3, j, i1 - 1, i2)) {
                    flag1 = true;
                    break;
                }
                if (i1 < 10 && aClass11Array1230[currentPlane].method220(k2, i2, k3, i1 - 1, j, j3)) {
                    flag1 = true;
                    break;
                }
            }
            if (k1 != 0 && k != 0 && aClass11Array1230[currentPlane].method221(i2, k2, j3, k, l1, k1, k3)) {
                flag1 = true;
                break;
            }
...
//	entityMessage(npc);
    ...
    private void method89(SceneSpawnNode class30_sub1) {
        int i = 0;
        int j = -1;
        int k = 0;
        int l = 0;
        ...
        if (i != 0) {
            int i1 = scene.method304(class30_sub1.anInt1295, class30_sub1.anInt1297, class30_sub1.anInt1298, i);
            j = i >> 14 & 0x7fff;
            k = i1 & 0x1f;
            l = i1 >> 6;
        }
    ...
    void startUp() {
        ...
        try {
            ...
            Rasterizer3D.method365(479, 96);
            anIntArray1180 = Rasterizer3D.anIntArray1472;
            Rasterizer3D.method365(190, 261);
            anIntArray1181 = Rasterizer3D.anIntArray1472;
            Rasterizer3D.method365(512, 334);
            ...
            com.runescape.media.renderable.GameObject.clientInstance = this;
            ObjectDef.clientInstance = this;
            EntityDef.clientInstance = this;
            try {
                gpu = new GpuPlugin();

                skybox = new SkyboxPlugin();
            } catch (Exception e) {
                e.printStackTrace();
                System.exit(0);
            }
    ...
    private void method96(Actor entity) {
    ...
    private void method97(Actor entity) {
    ...
    private void method98(Actor entity) {
    ...
    private void method99(Actor entity) {
    ...
    private void method100(Actor entity) {
    ...
    private void method101(Actor entity) {
    ...
    private void drawGameScreen() {
        if (welcomeScreenRaised) {
            welcomeScreenRaised = false;
            backLeft1Graphics.draw(super.graphics, 0, 4);
            backLeft2Graphics.draw(super.graphics, 0, 357);
            backRight1Graphics.draw(super.graphics, 722, 4);
            backRight2Graphics.draw(super.graphics, 743, 205);
            backTop1Graphics.draw(super.graphics, 0, 0);
            backMid1Graphics.draw(super.graphics, 516, 4);
            backMid2Graphics.draw(super.graphics, 516, 205);
            backMid3Graphics.draw(super.graphics, 496, 357);
            backMid4Graphics.draw(super.graphics, 0, 338);
            needDrawTabArea = true;
            inputTaken = true;
            tabAreaAltered = true;
            aBoolean1233 = true;
            if (loadingStage != 2) {
                gameBuffer.draw(super.graphics, 4, 4);
                mapBuffer.draw(super.graphics, 550, 4);
            }
        }
        if (loadingStage == 2)
            method146();
        ...
        if (tabAreaAltered) {
            ...
            bottomTabBuffer.draw(super.graphics, 516, 160);
            topTabBuffer.init();
            ...
            topTabBuffer.draw(super.graphics, 496, 466);
            gameBuffer.init();
        }
        if (aBoolean1233) {
            aBoolean1233 = false;
            chatOptionsBuffer.init();
            ...
            chatOptionsBuffer.draw(super.graphics, 0, 453);
            gameBuffer.init();
        }
        anInt945 = 0;
    }
    ...
    private void method104() {
        AnimatedGameObject class30_sub2_sub4_sub3 = (AnimatedGameObject) aClass19_1056.reverseGetFirst();
        for (; class30_sub2_sub4_sub3 != null; class30_sub2_sub4_sub3 = (AnimatedGameObject) aClass19_1056.reverseGetNext())
            if (class30_sub2_sub4_sub3.anInt1560 != currentPlane || class30_sub2_sub4_sub3.aBoolean1567)
    ...
    private void drawInterface(int j, int k, RSInterface class9, int l) {
        ...
        Raster.setDrawingArea(l + class9.height, k, k + class9.width, l);
                ...
                if (class9_1.type == 2) {
                    ...
                    for (int l3 = 0; l3 < class9_1.height; l3++) {
                        for (int l4 = 0; l4 < class9_1.width; l4++) {
                            ...
                            if (class9_1.inv[i3] > 0) {
                                ...
                                if (k5 > Raster.topX - 32 && k5 < Raster.bottomX && j6 > Raster.topY - 32 && j6 < Raster.bottomY || activeInterfaceType != 0 && anInt1085 == i3) {
                                    int l9 = 0;
                                    ...
                                    if (class30_sub2_sub1_sub1_2 != null) {
                                        if (activeInterfaceType != 0 && anInt1085 == i3 && anInt1084 == class9_1.id) {
                                            ...
                                            class30_sub2_sub1_sub1_2.drawSprite1(k5 + k6, j6 + j7, 128);
                                            if (j6 + j7 < Raster.topY && class9.scrollPosition > 0) {
                                            ...
                                            if (j6 + j7 + 32 > Raster.bottomY && class9.scrollPosition < class9.scrollMax - class9.height) {
                                            ...
                                            class30_sub2_sub1_sub1_2.drawSprite1(k5, j6, 128);
                                        else
                    ...
                    if (class9_1.aByte254 == 0) {
                        if (class9_1.aBoolean227)
                            Raster.method336(class9_1.height, l2, k2, j3, class9_1.width, false);
                        else
                            Raster.fillPixels(k2, class9_1.width, class9_1.height, j3, l2);
                    } else if (class9_1.aBoolean227)
                        Raster.method335(j3, l2, class9_1.width, class9_1.height, 256 - (class9_1.aByte254 & 0xff), k2);
                    else
                        Raster.method338(l2, class9_1.height, 256 - (class9_1.aByte254 & 0xff), j3, class9_1.width, k2);
                    ...
                    Rasterizer3D.textureInt1 = k2 + class9_1.width / 2;
        ...
        Raster.setDrawingArea(l1, i1, k1, j1);
    }
            ...
            if (player.name != null && player.visible) {
                ...
                if (!flag && anInt1251 == 0)
                    try {
                        ...
                        aStream_834.currentOffset = 0;
                        String s = ChatEncoder.method525(j3, aStream_834);
                        s = Censor.doCensor(s);
                        player.textSpoken = s;
    ...
    private void method108() {
        try {
            ...
            int l = anInt1014 >> 7;
            int i1 = anInt1015 >> 7;
            int j1 = method42(currentPlane, anInt1015, anInt1014);
            int k1 = 0;
    ...
    private void method115() {
        if (loadingStage == 2) {
            for (SceneSpawnNode class30_sub1 = (SceneSpawnNode) aClass19_1179.reverseGetFirst(); class30_sub1 != null; class30_sub1 = (SceneSpawnNode) aClass19_1179.reverseGetNext()) {
    ...
    private void method117(Stream stream) {
        ...
        if (k == 3) {
            currentPlane = stream.readBits(2);
            int j1 = stream.readBits(1);
    ...
    private int method120() {
        ...
        if (cameraPitch < 310) {
            ...
            int i1 = myPlayer.x >> 7;
            int j1 = myPlayer.y >> 7;
            if ((tileSettings[currentPlane][k][l] & 4) != 0)
                j = currentPlane;
            int k1;
            if (i1 > k)
                k1 = i1 - k;
        ...
        if ((tileSettings[currentPlane][myPlayer.x >> 7][myPlayer.y >> 7] & 4) != 0)
            j = currentPlane;
        return j;
    }

    private int method121() {
        int j = method42(currentPlane, cameraY, cameraX);
        if (j - cameraZ < 800 && (tileSettings[currentPlane][cameraX >> 7][cameraY >> 7] & 4) != 0)
            return currentPlane;
        else
            return 3;
    }
    ...
    private void drawTooltip() {
        ...
        chatTextDrawingArea.method389(false, 4, 0xffffff, s, 15);
    }
    ...
    private void drawMinimap() {
        ...
        for (int k5 = 0; k5 < 104; k5++) {
            for (int l5 = 0; l5 < 104; l5++) {
                NodeList class19 = groundArray[currentPlane][k5][l5];
                if (class19 != null) {
        ...
        Raster.method336(3, 78, 97, 0xffffff, 3, false);
        gameBuffer.init();
    }

    private void npcScreenPos(Actor entity, int i) {
...
//aryan	entity.entScreenX = spriteDrawX; entity.entScreenY = spriteDrawY;
    ...
    private void calcEntityScreenPos(int i, int j, int l) {
        ...
        int i1 = method42(currentPlane, l, i) - j;
        i -= cameraX;
        i1 -= cameraZ;
        l -= cameraY;
        ...
        i1 = j2;
        if (l >= 50) {
            spriteDrawX = Rasterizer3D.textureInt1 + (i << 9) / l;
            spriteDrawY = Rasterizer3D.textureInt2 + (i1 << 9) / l;
        } else {
            spriteDrawX = -1;
            spriteDrawY = -1;
        }
    ...
    private void method130(int j, int k, int l, int i1, int j1, int k1,
        ...
        SceneSpawnNode class30_sub1 = null;
        for (SceneSpawnNode class30_sub1_1 = (SceneSpawnNode) aClass19_1179.reverseGetFirst(); class30_sub1_1 != null; class30_sub1_1 = (SceneSpawnNode) aClass19_1179.reverseGetNext()) {
        ...
        if (class30_sub1 == null) {
            class30_sub1 = new SceneSpawnNode();
    ...
    private void doFlamesDrawing() {
        ...
        System.arraycopy(aClass30_Sub2_Sub1_Sub1_1201.myPixels, 0, aRSImageProducer_1110.pixels, 0, 33920);
        ...
        aRSImageProducer_1110.draw(super.graphics, 0, 0);
        System.arraycopy(aClass30_Sub2_Sub1_Sub1_1202.myPixels, 0, aRSImageProducer_1111.pixels, 0, 33920);
    ...
    private void drawLoginScreen(boolean flag) {
        ...
        if (loginScreenState == 2) {
            ...
            j += 15;
            chatTextDrawingArea.method389(true, c / 2 - 88, 0xffffff, "Password: " + TextUtilities.passwordAsterisks(myPassword) + ((loginScreenCursorPos == 1) & (loopCycle % 40 < 20) ? "@yel@|" : ""), j);
            j += 15;
            if (!flag) {
                int i1 = c / 2 - 80;
                int l1 = c1 / 2 + 50;
    ...
    private void method137(Stream stream, int j) {
        if (j == 84) {
            ...
            if (j3 >= 0 && i6 >= 0 && j3 < 104 && i6 < 104) {
                NodeList class19_1 = groundArray[currentPlane][j3][i6];
                if (class19_1 != null) {
        ...
        if (j == 215) {
            ...
            if (k6 >= 0 && j9 >= 0 && k6 < 104 && j9 < 104 && i12 != unknownInt10) {
                ...
                if (groundArray[currentPlane][k6][j9] == null)
                    groundArray[currentPlane][k6][j9] = new NodeList();
                groundArray[currentPlane][k6][j9].insertHead(class30_sub2_sub4_sub2_2);
        ...
        if (j == 156) {
            ...
            if (i4 >= 0 && l6 >= 0 && i4 < 104 && l6 < 104) {
                NodeList class19 = groundArray[currentPlane][i4][l6];
                if (class19 != null) {
                    for (Item item = (Item) class19.reverseGetFirst(); item != null; item = (Item) class19.reverseGetNext()) {
                    ...
                    if (class19.reverseGetFirst() == null)
                        groundArray[currentPlane][i4][l6] = null;
        ...
        if (j == 160) {
            ...
            if (j4 >= 0 && i7 >= 0 && j4 < 103 && i7 < 103) {
                int j18 = tileHeights[currentPlane][j4][i7];
                int i19 = tileHeights[currentPlane][j4 + 1][i7];
                int l19 = tileHeights[currentPlane][j4 + 1][i7 + 1];
                int k20 = tileHeights[currentPlane][j4][i7 + 1];
                if (j16 == 0) {
                    WallObject class10 = scene.method296(currentPlane, j4, i7);
                    if (class10 != null) {
                        int k21 = class10.uid >> 14 & 0x7fff;
                        if (j12 == 2) {
                            class10.renderableOne = new com.runescape.media.renderable.GameObject(k21, 4 + k14, 2, i19, l19, j18, k20, j17, false);
                            class10.renderableTwo = new com.runescape.media.renderable.GameObject(k21, k14 + 1 & 3, 2, i19, l19, j18, k20, j17, false);
                        } else {
                            class10.renderableOne = new com.runescape.media.renderable.GameObject(k21, k14, j12, i19, l19, j18, k20, j17, false);
                        }
                    }
                }
                if (j16 == 1) {
                    DecorativeObject class26 = scene.method297(j4, i7, currentPlane);
                    if (class26 != null)
                        class26.renderable = new com.runescape.media.renderable.GameObject(class26.uid >> 14 & 0x7fff, 0, 4, i19, l19, j18, k20, j17, false);
                }
                if (j16 == 2) {
                    GameObject class28 = scene.method298(j4, i7, currentPlane);
                    if (j12 == 11)
                        j12 = 10;
                    if (class28 != null)
                        class28.renderable = new com.runescape.media.renderable.GameObject(class28.uid >> 14 & 0x7fff, k14, j12, i19, l19, j18, k20, j17, false);
                }
                if (j16 == 3) {
                    GroundObject class49 = scene.method299(i7, j4, currentPlane);
                    if (class49 != null)
                        class49.renderable = new com.runescape.media.renderable.GameObject(class49.uid >> 14 & 0x7fff, k14, 22, i19, l19, j18, k20, j17, false);
                }
            }
            return;
        }
        if (j == 147) {
            ...
            if (player != null) {
                ...
                int i22 = tileHeights[currentPlane][k4][j7];
                int j22 = tileHeights[currentPlane][k4 + 1][j7];
                int k22 = tileHeights[currentPlane][k4 + 1][j7 + 1];
                int l22 = tileHeights[currentPlane][k4][j7 + 1];
                ...
                if (model != null) {
                    ...
                    player.anInt1712 = method42(currentPlane, player.anInt1713, player.anInt1711);
                    if (byte2 > byte0) {
                        byte byte4 = byte2;
                        byte2 = byte0;
                        byte0 = byte4;
        ...
        if (j == 4) {
            ...
            if (i5 >= 0 && l7 >= 0 && i5 < 104 && l7 < 104) {
                i5 = i5 * 128 + 64;
                l7 = l7 * 128 + 64;
                AnimatedGameObject class30_sub2_sub4_sub3 = new AnimatedGameObject(currentPlane, loopCycle, j15, k10, method42(currentPlane, l7, i5) - l12, l7, i5);
        ...
        if (j == 44) {
            ...
            if (l10 >= 0 && i13 >= 0 && l10 < 104 && i13 < 104) {
                ...
                if (groundArray[currentPlane][l10][i13] == null)
                    groundArray[currentPlane][l10][i13] = new NodeList();
                groundArray[currentPlane][l10][i13].insertHead(class30_sub2_sub4_sub2_1);
        ...
        if (j == 117) {
            ...
            if (l5 >= 0 && k8 >= 0 && l5 < 104 && k8 < 104 && j11 >= 0 && k13 >= 0 && j11 < 104 && k13 < 104 && i17 != 65535) {
                ...
                j11 = j11 * 128 + 64;
                k13 = k13 * 128 + 64;
                Projectile class30_sub2_sub4_sub4 = new Projectile(i21, l18, k19 + loopCycle, j20 + loopCycle, j21, currentPlane, method42(currentPlane, k8, l5) - i18, k8, l5, l15, i17);
                class30_sub2_sub4_sub4.method455(k19 + loopCycle, k13, method42(currentPlane, k13, j11) - l18, j11);
        ...
        if (i1 >= 1 && i >= 1 && i1 <= 102 && i <= 102) {
            ...
            if (k1 >= 0) {
                ...
                if (j3 < 3 && (tileSettings[1][i1][i] & 2) == 2)
                    j3++;
                Region.method188(scene, k, i, l, j3, aClass11Array1230[j], tileHeights, i1, k1, j);
            }
        }
    }
...
*/
    ...
    private boolean parsePacket() {
        ...
        try {
            ...
            if (pktType == -1) {
                ...
                pktSize = PacketConstants.packetSizes[pktType];
                i--;
            }
            if (pktSize == -1)
                if (i > 0) {
            ...
            if (pktType == 176) {
                ...
                if (anInt1193 != 0 && openInterfaceID == -1) {
                    Signlink.dnslookup(TextUtilities.method586(anInt1193));
                    clearTopInterfaces();
                    char c = '\u028A';
            ...
            if (pktType == 64) {
                ...
                for (int j = anInt1268; j < anInt1268 + 8; j++) {
                    for (int l9 = anInt1269; l9 < anInt1269 + 8; l9++)
                        if (groundArray[currentPlane][j][l9] != null) {
                            groundArray[currentPlane][j][l9] = null;
                ...
                for (SceneSpawnNode class30_sub1 = (SceneSpawnNode) aClass19_1179.reverseGetFirst(); class30_sub1 != null; class30_sub1 = (SceneSpawnNode) aClass19_1179.reverseGetNext())
                    if (class30_sub1.anInt1297 >= anInt1268 && class30_sub1.anInt1297 < anInt1268 + 8 && class30_sub1.anInt1298 >= anInt1269 && class30_sub1.anInt1298 < anInt1269 + 8 && class30_sub1.anInt1295 == currentPlane)
            ...
            if (pktType == 166) {
                ...
                if (anInt1102 >= 100) {
                    cameraX = anInt1098 * 128 + 64;
                    cameraY = anInt1099 * 128 + 64;
                    cameraZ = method42(currentPlane, cameraY, cameraX) - anInt1100;
                }
                pktType = -1;
                return true;
            }
            ...
            if (pktType == 196) {
                ...
                if (!flag5 && anInt1251 == 0)
                    try {
                        ...
                        String s9 = ChatEncoder.method525(pktSize - 13, inStream);
                        if (l21 != 3)
                            s9 = Censor.doCensor(s9);
                        if (l21 == 2 || l21 == 3)
                            pushMessage(s9, 7, "@cr2@" + TextUtilities.fixName(TextUtilities.nameForLong(l5)));
                        else if (l21 == 1)
                            pushMessage(s9, 7, "@cr1@" + TextUtilities.fixName(TextUtilities.nameForLong(l5)));
                        else
                            pushMessage(s9, 3, TextUtilities.fixName(TextUtilities.nameForLong(l5)));
            ...
            if (pktType == 177) {
                ...
                if (anInt999 >= 100) {
                    ...
                    int i20 = method42(currentPlane, k14, k7) - anInt997;
                    int l22 = k7 - cameraX;
                    int k25 = i20 - cameraZ;
                    int j28 = k14 - cameraY;
    ...
    private void method146() {
        ...
        if (!aBoolean1160) {
            ...
            setCameraPos(600 + i * 3, i, anInt1014, method42(currentPlane, myPlayer.y, myPlayer.x) - 50, k, anInt1015);
        }
        int j;
        if (!aBoolean1160)
            j = method120();
...
//xxx disables graphics			if(graphicsEnabled){
        ...
        scene.drawScene(cameraX, cameraY, cameraYaw, cameraZ, j, cameraPitch);
