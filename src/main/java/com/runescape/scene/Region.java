...
public final class Region {
    ...
    public static void method188(Scene scene, int i, int j, int k, int l, CollisionMap class11, int ai[][][], int i1,
                                 int j1, int k1) {
        int l1 = ai[l][i1][j];
        int i2 = ai[l][i1 + 1][j];
        ...
        if (k == 22) {
            ...
            scene.method280(k1, l2, j, ((Renderable) (obj)), byte1, i3, i1);
        ...
        if (k == 10 || k == 11) {
            ...
            if (obj1 != null) {
                ...
                scene.method284(i3, byte1, l2, i5, ((Renderable) (obj1)), k4, k1, j5, j, i1);
            }
        ...
        if (k >= 12) {
            ...
            scene.method284(i3, byte1, l2, 1, ((Renderable) (obj2)), 1, k1, 0, j, i1);
            if (class46.aBoolean767)
                class11.method212(class46.aBoolean757, class46.anInt744, class46.anInt761, i1, j, i);
            return;
        }
        if (k == 0) {
            ...
            scene.method282(anIntArray152[i], ((Renderable) (obj3)), i3, j, byte1, i1, null, l2, 0, k1);
            if (class46.aBoolean767)
        ...
        if (k == 1) {
            ...
            scene.method282(anIntArray140[i], ((Renderable) (obj4)), i3, j, byte1, i1, null, l2, 0, k1);
            if (class46.aBoolean767)
                class11.method211(j, i, i1, k, class46.aBoolean757);
            return;
        }
        if (k == 2) {
            ...
            scene.method282(anIntArray152[i], ((Renderable) (obj11)), i3, j, byte1, i1, ((Renderable) (obj12)), l2, anIntArray152[j3], k1);
            if (class46.aBoolean767)
                class11.method211(j, i, i1, k, class46.aBoolean757);
            return;
        }
        if (k == 3) {
            ...
            scene.method282(anIntArray140[i], ((Renderable) (obj5)), i3, j, byte1, i1, null, l2, 0, k1);
            if (class46.aBoolean767)
                class11.method211(j, i, i1, k, class46.aBoolean757);
            return;
        }
        if (k == 9) {
            ...
            scene.method284(i3, byte1, l2, 1, ((Renderable) (obj6)), 1, k1, 0, j, i1);
            if (class46.aBoolean767)
                class11.method212(class46.aBoolean757, class46.anInt744, class46.anInt761, i1, j, i);
            return;
        }
        ...
        if (k == 4) {
            ...
            scene.method283(i3, j, i * 512, k1, 0, l2, ((Renderable) (obj7)), i1, byte1, 0, anIntArray152[i]);
            return;
        }
        if (k == 5) {
            int j4 = 16;
            int l4 = scene.method300(k1, i1, j);
            if (l4 > 0)
            ...
            scene.method283(i3, j, i * 512, k1, anIntArray137[i] * j4, l2, ((Renderable) (obj13)), i1, byte1, anIntArray144[i] * j4, anIntArray152[i]);
            return;
        }
        if (k == 6) {
            Object obj8;
            ...
            scene.method283(i3, j, i, k1, 0, l2, ((Renderable) (obj8)), i1, byte1, 0, 256);
            return;
        }
        if (k == 7) {
            Object obj9;
            ...
            scene.method283(i3, j, i, k1, 0, l2, ((Renderable) (obj9)), i1, byte1, 0, 512);
            return;
        }
        if (k == 8) {
            Object obj10;
            ...
            scene.method283(i3, j, i, k1, 0, l2, ((Renderable) (obj10)), i1, byte1, 0, 768);
        }
    }
    ...
    public final void method171(CollisionMap aclass11[], Scene scene) {
        for (int j = 0; j < 4; j++) {
            for (int k = 0; k < 104; k++) {
        ...
        for (int l = 0; l < 4; l++) {
                            ...
                            if (l18 > 0 || i19 > 0) {
                                ...
                                if (i19 == 0) {
                                    ...
                                    if (i23 >= 0) {
                                        ...
                                        k23 = Rasterizer3D.anIntArray1482[method185(flo_2.anInt399, 96)];
                                    }
                                    scene.method279(l, l6, k17, k22, byte4, i23, j19, k19, l19, i20, method187(j21, j20), method187(j21, k20), method187(j21, l20), method187(j21, i21), method185(j23, j20), method185(j23, k20), method185(j23, l20), method185(j23, i21), i22, k23);
                                }
                            }
                        }
                    }
            ...
            for (int j8 = 1; j8 < anInt147 - 1; j8++) {
                for (int i10 = 1; i10 < anInt146 - 1; i10++)
                    scene.method278(l, i10, j8, method182(j8, l, i10));
    ...
    private void method175(int i, Scene scene, CollisionMap class11, int j, int k, int l, int i1,
                           int j1) {
        ...
        if (j == 22) {
            ...
            scene.method280(k, k2, i, ((Renderable) (obj)), byte0, l2, l);
        ...
        if (j == 10 || j == 11) {
            ...
            if (obj1 != null) {
                ...
                if (scene.method284(l2, byte0, k2, l4, ((Renderable) (obj1)), j4, k, i5, i, l) && class46.aBoolean779) {
                    Model model;
        ...
        if (j >= 12) {
            ...
            scene.method284(l2, byte0, k2, 1, ((Renderable) (obj2)), 1, k, 0, i, l);
        ...
        if (j == 0) {
            ...
            scene.method282(anIntArray152[j1], ((Renderable) (obj3)), l2, i, byte0, l, null, k2, 0, k);
            if (j1 == 0) {
            ...
            if (class46.anInt775 != 16)
                scene.method290(i, class46.anInt775, l, k);
            return;
        }
        if (j == 1) {
            Object obj4;
            ...
            scene.method282(anIntArray140[j1], ((Renderable) (obj4)), l2, i, byte0, l, null, k2, 0, k);
            if (class46.aBoolean779)
                if (j1 == 0)
                    aByteArrayArrayArray134[k][l][i + 1] = 50;
                else if (j1 == 1)
        ...
        if (j == 2) {
            ...
            scene.method282(anIntArray152[j1], ((Renderable) (obj11)), l2, i, byte0, l, ((Renderable) (obj12)), k2, anIntArray152[i3], k);
            if (class46.aBoolean764)
                if (j1 == 0) {
                    anIntArrayArrayArray135[k][l][i] |= 0x249;
                    anIntArrayArrayArray135[k][l][i + 1] |= 0x492;
        ...
        if (j == 3) {
            ...
            scene.method282(anIntArray140[j1], ((Renderable) (obj5)), l2, i, byte0, l, null, k2, 0, k);
            if (class46.aBoolean779)
                if (j1 == 0)
                    aByteArrayArrayArray134[k][l][i + 1] = 50;
                else if (j1 == 1)
        ...
        if (j == 9) {
            ...
            scene.method284(l2, byte0, k2, 1, ((Renderable) (obj6)), 1, k, 0, i, l);
            if (class46.aBoolean767 && class11 != null)
                class11.method212(class46.aBoolean757, class46.anInt744, class46.anInt761, l, i, j1);
            return;
        }
        ...
        if (j == 4) {
            ...
            scene.method283(l2, i, j1 * 512, k, 0, k2, ((Renderable) (obj7)), l, byte0, 0, anIntArray152[j1]);
            return;
        }
        if (j == 5) {
            int i4 = 16;
            int k4 = scene.method300(k, l, i);
            if (k4 > 0)
            ...
            scene.method283(l2, i, j1 * 512, k, anIntArray137[j1] * i4, k2, ((Renderable) (obj13)), l, byte0, anIntArray144[j1] * i4, anIntArray152[j1]);
            return;
        }
        if (j == 6) {
            Object obj8;
            ...
            scene.method283(l2, i, j1, k, 0, k2, ((Renderable) (obj8)), l, byte0, 0, 256);
            return;
        }
        if (j == 7) {
            Object obj9;
            ...
            scene.method283(l2, i, j1, k, 0, k2, ((Renderable) (obj9)), l, byte0, 0, 512);
            return;
        }
        if (j == 8) {
            Object obj10;
            ...
            scene.method283(l2, i, j1, k, 0, k2, ((Renderable) (obj10)), l, byte0, 0, 768);
        }
    }
            ...
            for (int i3 = 0; i3 < 64; i3++) {
                for (int j3 = 0; j3 < 64; j3++)
                    if (l2 == i && i3 >= i1 && i3 < i1 + 8 && j3 >= j1 && j3 < j1 + 8)
                        method181(l1 + TileUtilities.method156(j3 & 7, j, i3 & 7), 0, stream, l + TileUtilities.method155(j, j3 & 7, i3 & 7), k1, j, 0);
                    else
    ...
    public final void method183(CollisionMap aclass11[], Scene scene, int i, int j, int k, int l,
            ...
            do {
                ...
                do {
                    ...
                    if (j3 == i && i3 >= i1 && i3 < i1 + 8 && l2 >= k && l2 < k + 8) {
                        ...
                        int j4 = j + TileUtilities.method157(j1, class46.anInt761, i3 & 7, l2 & 7, class46.anInt744);
                        int k4 = k1 + TileUtilities.method158(l2 & 7, class46.anInt761, j1, class46.anInt744, i3 & 7);
                        if (j4 > 0 && k4 > 0 && j4 < 103 && k4 < 103) {
                            ...
                            if (l4 >= 0)
                                class11 = aclass11[l4];
                            method175(k4, scene, class11, l3, l, j4, l1, i4 + j1 & 3);
                        }
                    }
                } while (true);
            } while (true);
    ...
    public final void method190(int i, CollisionMap aclass11[], int j, Scene scene, byte abyte0[]) {
        label0:
        {
            Stream stream = new Stream(abyte0);
            int l = -1;
            do {
                ...
                do {
                    ...
                    if (j3 > 0 && k3 > 0 && j3 < 103 && k3 < 103) {
                        ...
                        if (l3 >= 0)
                            class11 = aclass11[l3];
                        method175(k3, scene, class11, l2, j2, j3, l, i3);
                    }
                } while (true);
            } while (true);
        }
