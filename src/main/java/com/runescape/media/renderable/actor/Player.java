package com.runescape.media.renderable.actor;// Decompiled by Jad v1.5.8f. Copyright 2001 Pavel Kouznetsov.
...
import com.runescape.cache.media.SpotAnim;
import com.runescape.cache.media.Animation;
import com.runescape.collection.MRUNodes;
import com.runescape.media.Class36;
...
public final class Player extends Actor {
    ...
    public void updatePlayer(Stream stream) {
        ...
        if (super.anInt1505 == 65535)
            super.anInt1505 = -1;
        name = TextUtilities.fixName(TextUtilities.nameForLong(stream.readQWord()));
