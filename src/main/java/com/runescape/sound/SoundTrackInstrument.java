package com.runescape.sound;// Decompiled by Jad v1.5.8f. Copyright 2001 Pavel Kouznetsov.
// Jad home page: http://www.kpdus.com/jad.html
// Decompiler options: packimports(3) 

import com.runescape.net.Stream;

public final class SoundTrackInstrument {
    ...
    public int anInt113;
    public int anInt114;
    private SoundTrackEnvelope aClass29_98;
    private SoundTrackEnvelope aClass29_99;
    private SoundTrackEnvelope aClass29_100;
    private SoundTrackEnvelope aClass29_101;
    private SoundTrackEnvelope aClass29_102;
    private SoundTrackEnvelope aClass29_103;
    private SoundTrackEnvelope aClass29_104;
    private SoundTrackEnvelope aClass29_105;
    private int anInt109;
    private int anInt110;
    private SoundFilter aClass39_111;
    private SoundTrackEnvelope aClass29_112;
    ...
    public void method169(Stream stream) {
        aClass29_98 = new SoundTrackEnvelope();
        aClass29_98.method325(stream);
        aClass29_99 = new SoundTrackEnvelope();
        aClass29_99.method325(stream);
        int i = stream.readUnsignedByte();
        if (i != 0) {
            stream.currentOffset--;
            aClass29_100 = new SoundTrackEnvelope();
            aClass29_100.method325(stream);
            aClass29_101 = new SoundTrackEnvelope();
            aClass29_101.method325(stream);
        }
        i = stream.readUnsignedByte();
        if (i != 0) {
            stream.currentOffset--;
            aClass29_102 = new SoundTrackEnvelope();
            aClass29_102.method325(stream);
            aClass29_103 = new SoundTrackEnvelope();
            aClass29_103.method325(stream);
        }
        i = stream.readUnsignedByte();
        if (i != 0) {
            stream.currentOffset--;
            aClass29_104 = new SoundTrackEnvelope();
            aClass29_104.method325(stream);
            aClass29_105 = new SoundTrackEnvelope();
        ...
        aClass29_112 = new SoundTrackEnvelope();
