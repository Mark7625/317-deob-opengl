...
public final class Sounds {
    ...
    private final SoundTrackInstrument[] aClass6Array329;
    private int anInt330;
    private int anInt331;

    private Sounds() {
        aClass6Array329 = new SoundTrackInstrument[10];
    }

    public static void unpack(Stream stream) {
        aByteArray327 = new byte[0x6baa8];
        aStream_328 = new Stream(aByteArray327);
        SoundTrackInstrument.method166();
        do {
    ...
    private void method242(Stream stream) {
        for (int i = 0; i < 10; i++) {
            ...
            if (j != 0) {
                ...
                aClass6Array329[i] = new SoundTrackInstrument();
